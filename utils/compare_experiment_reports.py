...
def summarize_report(report_dir: Path) -> dict:
    ...
    return {
        ...
        "baseline_source": manifest.get("baseline_source", ""),
        "baseline_best_win_rate": to_float(manifest.get("baseline_best_win_rate"), ""),
        "baseline_best_enemy_tower_hp": to_float(manifest.get("baseline_best_enemy_tower_hp"), ""),
        "baseline_late_death": to_float(manifest.get("baseline_late_death"), ""),
        "baseline_best_hero_damage_balance": to_float(manifest.get("baseline_best_hero_damage_balance"), ""),
...
def write_csv(rows: list[dict], output_path: Path):
    ...
    fieldnames = [
        ...
        "success_metrics",
        "baseline_source",
        "baseline_best_win_rate",
        "baseline_best_enemy_tower_hp",
        "baseline_late_death",
