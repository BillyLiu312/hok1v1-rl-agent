---
title: 分布式计算框架
source: https://tencentarena.com/docs/p-edu-hok1v1/64.3.1/taa-rl-fw/distributed_computing_fw
saved_at: 2026-06-22
---
...
![1_整体架构_图](../assets/images/framework-bb38a90de67f6fd1aa78998cbbb8a212.png)
...
训练工作流的核心函数，在workflow中可自定义训练流程。可以在[智能体/工作流开发](./rl_agent/workflow.md)中查看详细的训练工作流代码示例。
