---
title: 综述
source: https://tencentarena.com/docs/p-edu-hok1v1/64.3.1/taa-rl-fw/intro
saved_at: 2026-06-22
---
...
腾讯开悟强化学习开发框架是基于[强化学习系统系列技术标准](./rl_standard.md)打造的标准化开发套件。该框架为开发者提供了标准化的编程接口和丰富的工具集，支持开发者高效完成智能体开发、环境交互，以及模型的训练及预测流程。

## 训练流程简介

本开发框架的完整训练流程如下图所示：

![开发任务描述](../assets/images/agent_train-3333b0ffcb334acdc7420a9ebdc38b32.png)
...
- [强化学习环境系统](./rl_env.md)：提供标准的**强化学习环境接口**。开发者可以通过标准接口，实现智能体与环境的交互。
- [强化学习智能体开发套件](./rl_agent/info.md)：提供标准的**强化学习智能体接口**，以及算法库、模型组件库等工具函数库。开发者可以通过工具函数库快速完成智能体的构建。
- [强化学习分布式计算框架](./distributed_computing_fw.md)：提供标准接口，支持开发者按需实现训练工作流，运行单机或分布式的训练及评估任务。
