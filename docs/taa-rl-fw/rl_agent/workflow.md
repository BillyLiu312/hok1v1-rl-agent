---
title: 工作流开发
source: https://tencentarena.com/docs/p-edu-hok1v1/64.3.1/taa-rl-fw/rl_agent/workflow
saved_at: 2026-06-22
---
...
在完成智能体开发后，需要进一步实现由[分布式计算框架](../distributed_computing_fw.md)提供的训练工作流接口，使智能体和环境持续交互，收集训练样本，迭代模型参数，最终完成策略的优化。
