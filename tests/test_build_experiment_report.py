...
""",
            ...
            self.assertIn("research_story_summary_csv", manifest)
...
""",
            ...
            story_csv = artifacts["research_story_summary_csv"].read_text(encoding="utf-8")
            story_md = artifacts["research_story_summary_md"].read_text(encoding="utf-8")
